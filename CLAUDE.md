...
| 2026-08-30 | **Backfill-functie 6M**: `backfill-price-change-6mo` vult `signal_price_summary.pct_change_6mo` voor tickers die die waarde nog missen — favorieten eerst, batches met 110s-budget, draait ook als de beurzen dicht zijn (poll-prices doet dat alleen bij open beurs). Raakt alleen die ene kolom aan: geen koersen, signalen of poll-status. Handmatig aanroepen via `select invoke_edge('backfill-price-change-6mo')` tot "0 bijgewerkt"; geen cron. |
