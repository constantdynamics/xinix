...
| `xinix_hippo_calibration` | Eén rij per horizon (7 en 14 dagen): gepoolde basiskans, lifts per kenmerk, kalibratie (model vs. werkelijkheid) en het gemeten plafond |
