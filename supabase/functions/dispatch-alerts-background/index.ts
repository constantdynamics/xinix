...
const SUFFIX_TO_EXCHANGE: Record<string, string> = { V: "CVE", TO: "TSE", CN: "CNSX", AX: "ASX", L: "LON", HK: "HKG", T: "TYO", PA: "EPA", DE: "ETR", AS: "AMS", BR: "EBR", MI: "BIT", MC: "BME", ST: "STO", HE: "HEL", SW: "SWX" };
